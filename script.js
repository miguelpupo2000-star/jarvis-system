...
export default async function handler(req) {
  // Libera as permissões de segurança básicas
  ...
  try {
    ...
    // Puxa a chave que vamos embutir no painel da Vercel em segredo
    ...
    return new Response(JSON.stringify({ erro: "Falha central de barramento" }), { status: 500 });
  }
}
