// api/chat.js (Calibrado com a porta oficial estável de servidores Vercel)
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const opcoes = {
      hostname: '://groq.com',
      port: 443, // 🎯 AJUSTADO: Porta HTTPS padrão mundial sem bloqueios
    ...
    const requisicao = https.request(opcoes, (respostaServidor) => {
      ...
      respostaServidor.on('end', () => {
        try {
          ...
          const respostaTexto = dadosJSON.choices[message.content];
